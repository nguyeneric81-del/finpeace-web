...
export default function UpgradeCTA({ currentTier, lockedCount, onUpgradeClick }: UpgradeCTAProps) {
  ...
  return (
    <motion.section
      ...
      style={{
        background: 'linear-gradient(135deg, rgba(16,185,129,0.12), rgba(5,150,105,0.08), rgba(6,11,20,0.8))',
    ...
    >
      ...
      <div className="relative z-10 p-5">
        ...
        <motion.button
          ...
          whileTap={{ scale: 0.97 }}
          className="w-full flex items-center justify-center gap-2 py-3.5 rounded-xl font-bold text-sm cursor-pointer mt-4"
          style={{
