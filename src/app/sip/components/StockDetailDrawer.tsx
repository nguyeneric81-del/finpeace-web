        ...
        <div className="fixed inset-y-0 right-0 max-w-full flex pl-10">
          ...
          >
            ...
            <div className="flex-1 overflow-y-auto p-6 space-y-6">
              {/* FinPeace Canvas LV3 Institutional Presentation Banner */}
              {stock.canvasPresentationUrl && (
                <div className="p-4 rounded-2xl bg-gradient-to-r from-amber-500/20 via-orange-500/15 to-purple-500/20 border border-amber-500/40 shadow-xl relative overflow-hidden group">
                  <div className="flex flex-col sm:flex-row sm:items-center justify-between gap-3">
                    <div>
                      <div className="flex items-center gap-2">
                        <span className="px-2 py-0.5 rounded text-[10px] font-black uppercase tracking-wider bg-gradient-to-r from-amber-500 to-orange-500 text-slate-950">
                          Canvas LV3
                        </span>
                      ...
                      <h4 className="text-sm font-bold text-white mt-1 group-hover:text-amber-300 transition">
                        {stock.canvasReportTitle || `Bản Thuyết Trình Thể Chế ${stock.ticker}`}
                      </h4>
                      <p className="text-xs text-slate-300 mt-0.5">
                        Chu kỳ ngành · Con hào kinh tế · Định giá Key Driver & The Ceiling
                      </p>
                    </div>
                    ...
                    <a
                      ...
                      className="px-4 py-2 rounded-xl bg-gradient-to-r from-amber-500 to-orange-500 hover:from-amber-400 hover:to-orange-400 text-slate-950 font-black text-xs shadow-lg shadow-amber-500/20 flex items-center justify-center gap-1.5 shrink-0 transition"
                    >
                      <span>Mở Bản Thuyết Trình</span>
